...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.Pressure_val.place(y =70,x = 100)  
        ...
        self.Data_record_Start = customtkinter.CTkButton(master=self.sidebar_frame_left.tab("Pres Cont"),width=170,height=25,border_width=0,corner_radius=8,text="STA_Data_Col",command=self.Start_data_Collection)
        self.Data_record_Start.place(y=300, x=15)
        self.Data_record_Stop = customtkinter.CTkButton(master=self.sidebar_frame_left.tab("Pres Cont"),width=170,height=25,border_width=0,corner_radius=8,text="STo_Data_Col",command=self.Stop_data_Collection)
        self.Data_record_Stop.place(y=355, x=15)        
        ...
        self.Valve1 = customtkinter.CTkCheckBox(self.man_cont_frame.tab("Automatic control"), text = "Valve 1",checkbox_width = 15,checkbox_height = 15,corner_radius=8, width=110, height=25, command = self.Check_Radio_Button)
        self.Valve1.place(y=250, x=30)
        self.Valve2 = customtkinter.CTkCheckBox(self.man_cont_frame.tab("Automatic control"), text = "Valve 2",checkbox_width = 15,checkbox_height = 15,corner_radius=8, width=110, height=25)
        self.Valve2.place(y=250, x=150)
        self.Valve3 = customtkinter.CTkCheckBox(self.man_cont_frame.tab("Automatic control"), text = "Valve 3",checkbox_width = 15,checkbox_height = 15,corner_radius=8, width=110, height=25)
        self.Valve3.place(y=280, x=30)
        self.Valve4 = customtkinter.CTkCheckBox(self.man_cont_frame.tab("Automatic control"), text = "Valve 4",checkbox_width = 15,checkbox_height = 15,corner_radius=8, width=110, height=25)
